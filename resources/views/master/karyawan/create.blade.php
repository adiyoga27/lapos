...
<div class="card-header"><h4 class="card-title mb-0"><i class="fa-solid fa-plus me-1"></i>Tambah Karyawan</h4></div>
<div class="card-body">
...
<option value="{{ $lvl->kode }}" {{ old('level') == $lvl->kode ? 'selected' : '' }}>{{ $lvl->nama }}</option>
@endforeach
</select>
...
<input type="number" name="gaji" value="{{ old('gaji', 0) }}" step="0.01" class="form-control @error('gaji') is-invalid @enderror" placeholder="Masukkan gaji">
