    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('barang.index') }}" class="btn btn-secondary btn-sm"><i class="fa-solid fa-arrow-left me-1"></i>Kembali</a>
            </div>
            <div class="card-body">
                <form action="{{ route('barang.store') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="golongan" class="form-select @error('golongan') is-invalid @enderror">
                                ...
                                @foreach($golongan as $gol)
                                    <option value="{{ $gol->kode }}" {{ old('golongan') == $gol->kode ? 'selected' : '' }}>{{ $gol->kode }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="subgolongan1" value="{{ old('subgolongan1') }}" class="form-control @error('subgolongan1') is-invalid @enderror" placeholder="Sub golongan 1">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="subgolongan2" value="{{ old('subgolongan2') }}" class="form-control @error('subgolongan2') is-invalid @enderror" placeholder="Sub golongan 2">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="satuan2" value="{{ old('satuan2') }}" class="form-control @error('satuan2') is-invalid @enderror" placeholder="Satuan 2">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="satuan3" value="{{ old('satuan3') }}" class="form-control @error('satuan3') is-invalid @enderror" placeholder="Satuan 3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="isi2" value="{{ old('isi2', 1) }}" class="form-control @error('isi2') is-invalid @enderror" placeholder="Isi 2">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="isi3" value="{{ old('isi3', 1) }}" class="form-control @error('isi3') is-invalid @enderror" placeholder="Isi 3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="harga_toko" value="{{ old('harga_toko', 0) }}" step="0.01" class="form-control @error('harga_toko') is-invalid @enderror" placeholder="Harga toko">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="harga_toko2" value="{{ old('harga_toko2', 0) }}" step="0.01" class="form-control @error('harga_toko2') is-invalid @enderror" placeholder="Harga toko 2">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="harga_toko3" value="{{ old('harga_toko3', 0) }}" step="0.01" class="form-control @error('harga_toko3') is-invalid @enderror" placeholder="Harga toko 3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="harga_partai" value="{{ old('harga_partai', 0) }}" step="0.01" class="form-control @error('harga_partai') is-invalid @enderror" placeholder="Harga partai">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="harga_partai2" value="{{ old('harga_partai2', 0) }}" step="0.01" class="form-control @error('harga_partai2') is-invalid @enderror" placeholder="Harga partai 2">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="harga_partai3" value="{{ old('harga_partai3', 0) }}" step="0.01" class="form-control @error('harga_partai3') is-invalid @enderror" placeholder="Harga partai 3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="harga_cabang" value="{{ old('harga_cabang', 0) }}" step="0.01" class="form-control @error('harga_cabang') is-invalid @enderror" placeholder="Harga cabang">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="harga_cabang2" value="{{ old('harga_cabang2', 0) }}" step="0.01" class="form-control @error('harga_cabang2') is-invalid @enderror" placeholder="Harga cabang 2">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="harga_cabang3" value="{{ old('harga_cabang3', 0) }}" step="0.01" class="form-control @error('harga_cabang3') is-invalid @enderror" placeholder="Harga cabang 3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="margin_toko" value="{{ old('margin_toko', 0) }}" step="0.01" class="form-control @error('margin_toko') is-invalid @enderror" placeholder="Margin toko">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="margin_partai" value="{{ old('margin_partai', 0) }}" step="0.01" class="form-control @error('margin_partai') is-invalid @enderror" placeholder="Margin partai">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="margin_cabang" value="{{ old('margin_cabang', 0) }}" step="0.01" class="form-control @error('margin_cabang') is-invalid @enderror" placeholder="Margin cabang">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="kode_barcode2" value="{{ old('kode_barcode2') }}" class="form-control @error('kode_barcode2') is-invalid @enderror" placeholder="Kode barcode 2">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="kode_barcode3" value="{{ old('kode_barcode3') }}" class="form-control @error('kode_barcode3') is-invalid @enderror" placeholder="Kode barcode 3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="stokmin" value="{{ old('stokmin', 0) }}" class="form-control @error('stokmin') is-invalid @enderror" placeholder="Stok minimum">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="stokmax" value="{{ old('stokmax', 0) }}" class="form-control @error('stokmax') is-invalid @enderror" placeholder="Stok maksimum">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea name="ket" rows="3" class="form-control @error('ket') is-invalid @enderror" placeholder="Keterangan">{{ old('ket') }}</textarea>
