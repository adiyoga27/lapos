...
<style>
    ...
    .nav-tabs .nav-link.active { background-color: #198754; color: #fff; border-color: #198754; }
    ...
    .img-preview:hover { border-color: #198754; color: #198754; }
...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('barang.update', $barang->kode) }}" method="POST" id="barangForm" enctype="multipart/form-data">
                    @csrf @method('PUT')
                                    ...
                                    <div class="field-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input type="number" name="isi" value="{{ old('isi', $barang->isi ?? 1) }}" class="form-control @error('isi') is-invalid @enderror" placeholder="Isi">
                                    ...
                                    <div class="field-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input type="number" name="hpp" value="{{ old('hpp', $barang->hpp ?? 0) }}" step="0.01" class="form-control @error('hpp') is-invalid @enderror" placeholder="Harga Pokok">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input type="number" name="harga_toko" value="{{ old('harga_toko', $barang->harga_toko ?? 0) }}" step="0.01" class="form-control @error('harga_toko') is-invalid @enderror" placeholder="Harga jual toko">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input type="number" name="toko" value="{{ old('toko', $barang->toko ?? 0) }}" class="form-control @error('toko') is-invalid @enderror" placeholder="Stok toko">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input type="number" name="gudang" value="{{ old('gudang', $barang->gudang ?? 0) }}" class="form-control @error('gudang') is-invalid @enderror" placeholder="Stok gudang">
                                    ...
                                    <div class="field-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input type="number" name="diskon" value="{{ old('diskon', $barang->diskon ?? 0) }}" step="0.01" class="form-control @error('diskon') is-invalid @enderror" placeholder="Diskon">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input type="number" name="point" value="{{ old('point', $barang->point ?? 0) }}" class="form-control @error('point') is-invalid @enderror" placeholder="Point member">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input type="number" name="point_m" value="{{ old('point_m', $barang->point_m ?? 0) }}" class="form-control @error('point_m') is-invalid @enderror" placeholder="Point karyawan">
                                    ...
                                    <div class="field-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input type="text" name="tgl_terakhir" value="{{ old('tgl_terakhir', $barang->tgl_terakhir) }}" class="form-control" placeholder="YYYY-MM-DD" readonly>
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                <label class="form-label"><i class="fa-solid fa-square-check me-1"></i>Ada Expired Date</label>
                                                <div class="form-check mt-2">
                                                    <input class="form-check-input" type="checkbox" name="ada_expired_date" value="1" id="adaExpired" {{ old('ada_expired_date', $barang->ada_expired_date) ? 'checked' : '' }}>
                                    ...
                                    <div class="field-group text-center">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="img-preview mb-2" id="preview1" onclick="document.getElementById('imgGambar1').click()">
                                                <img src="/build/images/barang/{{ $barang->gambar }}" class="img-fluid" alt="Gambar 1">
                                            </div>
                                            @else
                                            <div class="img-preview mb-2" id="preview1" onclick="document.getElementById('imgGambar1').click()">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="img-preview mb-2" id="preview2" onclick="document.getElementById('imgGambar2').click()">
                                                <img src="/build/images/barang/{{ $barang->gambar2 }}" class="img-fluid" alt="Gambar 2">
                                            </div>
                                            @else
                                            <div class="img-preview mb-2" id="preview2" onclick="document.getElementById('imgGambar2').click()">
                                        ...
                                        <div class="form-check d-flex justify-content-start mb-2">
                                            <input class="form-check-input" type="checkbox" name="nol_price" value="1" id="nolPrice" {{ old('nol_price', $barang->nol_price) ? 'checked' : '' }}>
                                            <label class="form-check-label ms-2" for="nolPrice">Open Price <small class="text-muted">[Harga Jual Toko]</small></label>
                                        </div>
                                        <div class="form-check d-flex justify-content-start">
                                            <input class="form-check-input" type="checkbox" name="nol_price_diskon" value="1" id="nolPriceDiskon" {{ old('nol_price_diskon', $barang->nol_price_diskon) ? 'checked' : '' }}>
                                    ...
                                    <table class="table table-bordered table-sm pricetable">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input type="number" name="isi" value="{{ old('isi', $barang->isi ?? 1) }}" class="form-control form-control-sm text-center" step="any"></td>
                                                <td><input type="number" name="harga_toko" value="{{ old('harga_toko', $barang->harga_toko ?? 0) }}" step="0.01" class="form-control form-control-sm text-end"></td>
                                                <td><input type="number" name="margin_toko" value="{{ old('margin_toko', $barang->margin_toko ?? 0) }}" step="0.01" class="form-control form-control-sm text-end"></td>
                                                <td><input type="number" name="harga_partai" value="{{ old('harga_partai', $barang->harga_partai ?? 0) }}" step="0.01" class="form-control form-control-sm text-end"></td>
                                                <td><input type="number" name="margin_partai" value="{{ old('margin_partai', $barang->margin_partai ?? 0) }}" step="0.01" class="form-control form-control-sm text-end"></td>
                                                <td><input type="number" name="harga_cabang" value="{{ old('harga_cabang', $barang->harga_cabang ?? 0) }}" step="0.01" class="form-control form-control-sm text-end"></td>
                                                <td><input type="number" name="harga_toko" value="{{ old('harga_toko', $barang->harga_toko ?? 0) }}" step="0.01" class="form-control form-control-sm text-end"></td>
                                                <td><input type="text" name="kode_barcode" value="{{ old('kode_barcode', $barang->kode_barcode) }}" class="form-control form-control-sm"></td>
                                                <td><input type="text" name="nama" value="{{ old('nama', $barang->nama) }}" class="form-control form-control-sm"></td>
                                            </tr>
                                            <tr>
                                                <td class="text-center fw-bold">2</td>
                                                <td><input type="text" name="satuan2" value="{{ old('satuan2', $barang->satuan2) }}" class="form-control form-control-sm" placeholder="Satuan 2"></td>
                                                <td><input type="number" name="isi2" value="{{ old('isi2', $barang->isi2 ?? 1) }}" class="form-control form-control-sm text-center"></td>
                                                <td><input type="number" name="harga_toko2" value="{{ old('harga_toko2', $barang->harga_toko2 ?? 0) }}" step="0.01" class="form-control form-control-sm text-end"></td>
                                                <td><input type="number" name="margin_toko2" value="{{ old('margin_toko2', $barang->margin_toko2 ?? 0) }}" step="0.01" class="form-control form-control-sm text-end"></td>
                                                <td><input type="number" name="harga_partai2" value="{{ old('harga_partai2', $barang->harga_partai2 ?? 0) }}" step="0.01" class="form-control form-control-sm text-end"></td>
                                                <td><input type="number" name="margin_partai2" value="{{ old('margin_partai2', $barang->margin_partai2 ?? 0) }}" step="0.01" class="form-control form-control-sm text-end"></td>
                                                <td><input type="number" name="harga_cabang2" value="{{ old('harga_cabang2', $barang->harga_cabang2 ?? 0) }}" step="0.01" class="form-control form-control-sm text-end"></td>
                                                <td>&mdash;</td>
                                                <td><input type="text" name="kode_barcode2" value="{{ old('kode_barcode2', $barang->kode_barcode2) }}" class="form-control form-control-sm"></td>
                                                <td><input type="text" name="nama2" value="{{ old('nama2', $barang->nama2) }}" class="form-control form-control-sm"></td>
                                            </tr>
                                            <tr>
                                                <td class="text-center fw-bold">3</td>
                                                <td><input type="text" name="satuan3" value="{{ old('satuan3', $barang->satuan3) }}" class="form-control form-control-sm" placeholder="Satuan 3"></td>
                                                <td><input type="number" name="isi3" value="{{ old('isi3', $barang->isi3 ?? 1) }}" class="form-control form-control-sm text-center"></td>
                                                <td><input type="number" name="harga_toko3" value="{{ old('harga_toko3', $barang->harga_toko3 ?? 0) }}" step="0.01" class="form-control form-control-sm text-end"></td>
                                                <td><input type="number" name="margin_toko3" value="{{ old('margin_toko3', $barang->margin_toko3 ?? 0) }}" step="0.01" class="form-control form-control-sm text-end"></td>
                                                <td><input type="number" name="harga_partai3" value="{{ old('harga_partai3', $barang->harga_partai3 ?? 0) }}" step="0.01" class="form-control form-control-sm text-end"></td>
                                                <td><input type="number" name="margin_partai3" value="{{ old('margin_partai3', $barang->margin_partai3 ?? 0) }}" step="0.01" class="form-control form-control-sm text-end"></td>
                                                <td><input type="number" name="harga_cabang3" value="{{ old('harga_cabang3', $barang->harga_cabang3 ?? 0) }}" step="0.01" class="form-control form-control-sm text-end"></td>
                                                <td>&mdash;</td>
                                                <td><input type="text" name="kode_barcode3" value="{{ old('kode_barcode3', $barang->kode_barcode3) }}" class="form-control form-control-sm"></td>
                                                <td><input type="text" name="nama3" value="{{ old('nama3', $barang->nama3) }}" class="form-control form-control-sm"></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="field-group">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="merk" value="{{ old('merk', $barang->merk) }}" class="form-control" placeholder="Merek barang">
                                        </div>
                                        <div class="mb-0">
                                            <label class="form-label">Lokasi RAK</label>
                                            <input type="text" name="lokasi" value="{{ old('lokasi', $barang->lokasi) }}" class="form-control" placeholder="Lokasi rak">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="field-group">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="stokmin" value="{{ old('stokmin', $barang->stokmin ?? 0) }}" class="form-control" placeholder="Stok minimum">
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Stok Max Toko</label>
                                            <input type="number" name="stokmax" value="{{ old('stokmax', $barang->stokmax ?? 0) }}" class="form-control" placeholder="Stok maksimum">
                                        </div>
                                        <div class="mb-0">
                                            <label class="form-label">Stok Min Gudang</label>
                                            <input type="number" name="stokmin_gudang" value="{{ old('stokmin_gudang', $barang->stokmin_gudang ?? 0) }}" class="form-control" placeholder="Stok min gudang">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="field-group">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="stokmax_gudang" value="{{ old('stokmax_gudang', $barang->stokmax_gudang ?? 0) }}" class="form-control" placeholder="Stok max gudang">
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Stok Rusak Toko</label>
                                            <input type="number" name="toko_rusak" value="{{ old('toko_rusak', $barang->toko_rusak ?? 0) }}" class="form-control" placeholder="0">
                                        </div>
                                        <div class="mb-0">
                                            <label class="form-label">Stok Rusak Gudang</label>
                                            <input type="number" name="gudang_rusak" value="{{ old('gudang_rusak', $barang->gudang_rusak ?? 0) }}" class="form-control" placeholder="0">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="field-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="number" name="diskon_toko" value="{{ old('diskon_toko', $barang->diskon_toko ?? 0) }}" step="0.01" class="form-control" placeholder="Diskon toko">
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label">Diskon Reseller</label>
                                                <input type="number" name="diskon_partai" value="{{ old('diskon_partai', $barang->diskon_partai ?? 0) }}" step="0.01" class="form-control" placeholder="Diskon partai">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="field-group">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="ket" rows="2" class="form-control" placeholder="Keterangan tambahan">{{ old('ket', $barang->ket) }}</textarea>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="paket" value="1" id="paket" {{ old('paket', $barang->paket) ? 'checked' : '' }}>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select name="tipe_disc_member" class="form-select">
                                                    <option value="%" {{ old('tipe_disc_member', $barang->tipe_disc_member) == '%' ? 'selected' : '' }}>Persen (%)</option>
                                                    <option value="rp" {{ old('tipe_disc_member', $barang->tipe_disc_member) == 'rp' ? 'selected' : '' }}>Rupiah (Rp)</option>
                                                </select>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label">Jumlah Diskon</label>
                                                <input type="number" name="jum_diskon_member" value="{{ old('jum_diskon_member', $barang->jum_diskon_member ?? 0) }}" step="0.01" class="form-control" placeholder="Jumlah diskon member">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="field-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <input type="number" name="jum_komisi_sales" value="{{ old('jum_komisi_sales', $barang->jum_komisi_sales ?? 0) }}" step="0.01" class="form-control" placeholder="Komisi sales">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <table class="table table-bordered table-sm pricetable">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><input type="number" name="harga_member" value="{{ old('harga_member', $barang->harga_member ?? 0) }}" step="0.01" class="form-control form-control-sm text-end"></td>
                                                        <td>&mdash;</td>
                                                        <td><input type="number" name="harga_karyawan" value="{{ old('harga_karyawan', $barang->harga_karyawan ?? 0) }}" step="0.01" class="form-control form-control-sm text-end"></td>
                                                        <td>&mdash;</td>
                                                    </tr>
                                                </tbody>
                                            </table>
