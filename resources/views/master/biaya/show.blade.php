...
@section('title') Detail Biaya @endsection
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2 no-print">
                <div>
                    <h4 class="card-title mb-0">Detail Biaya</h4>
                ...
                <div class="d-flex gap-1">
                    ...
                    <a href="{{ route('biaya.edit', $item->kode) }}" class="btn btn-primary btn-sm"><i class="fa-solid fa-pen-to-square me-1"></i>Edit</a>
                    <a href="{{ route('biaya.index') }}" class="btn btn-outline-secondary btn-sm"><i class="fa-solid fa-arrow-left me-1"></i>Kembali</a>
                </div>
            </div>
            <div class="card-body">
                <div class="row align-items-center mb-4 pb-3 border-bottom">
                    <div class="col-md-8">
                        ...
                        <span class="badge bg-dark"><i class="fa-solid fa-coins me-1"></i>{{ $item->kode }}</span>
                    </div>
                </div>

                <div class="row g-3">
                    <div class="col-12"><span class="section-title text-primary"><i class="fa-solid fa-circle-info me-1"></i> Informasi Biaya</span></div>
                    <div class="col-6 col-md-4">
                        <div class="detail-label">Kode Biaya</div>
