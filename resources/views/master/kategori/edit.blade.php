    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h4 class="card-title mb-0"><i class="fa-solid fa-pen me-1"></i>Edit Kategori</h4>
                <a href="{{ route('kategori.index') }}" class="btn btn-secondary btn-sm"><i class="fa-solid fa-arrow-left"></i> Kembali</a>
            </div>
            <div class="card-body">
                <form action="{{ route('kategori.update', $item->kode) }}" method="POST">
                    @csrf @method('PUT')
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="point_member" value="{{ old('point_member', $item->point_member) }}" class="form-control @error('point_member') is-invalid @enderror" placeholder="Point member">
