        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2 no-print">
                ...
                <div class="d-flex gap-1">
                    ...
                    <a href="{{ route('kategori.edit', $item->kode) }}" class="btn btn-primary btn-sm"><i class="fa-solid fa-pen-to-square me-1"></i>Edit</a>
                    <a href="{{ route('kategori.index') }}" class="btn btn-outline-secondary btn-sm"><i class="fa-solid fa-arrow-left me-1"></i>Kembali</a>
                </div>
            </div>
            <div class="card-body">
                <div class="row align-items-center mb-4 pb-3 border-bottom">
                    <div class="col-md-8">
                        ...
                        <span class="badge bg-dark"><i class="fa-solid fa-tag me-1"></i>Kategori</span>
                    </div>
                    <div class="col-md-4 text-md-end mt-2 mt-md-0">
                        <div class="detail-label">Point Member</div>
                        <div class="fs-4 fw-bold text-primary">{{ number_format($item->point_member, 0, ',', '.') }}</div>
                    </div>
                </div>

                <div class="row g-3">
                    <div class="col-12"><span class="section-title text-primary"><i class="fa-solid fa-circle-info me-1"></i> Informasi Kategori</span></div>
                    ...
                    <div class="col-6 col-md-4">
                        <div class="detail-label">Point Member</div>
                        <div class="detail-value">{{ number_format($item->point_member, 0, ',', '.') }}</div>
                    </div>
                </div>
            </div>
        </div>
