    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h4 class="card-title mb-0"><i class="fa-solid fa-pen me-1"></i>Edit Member</h4>
                <a href="{{ route('member.index') }}" class="btn btn-secondary btn-sm"><i class="fa-solid fa-arrow-left"></i> Kembali</a>
            </div>
            <div class="card-body">
                <form action="{{ route('member.update', $item->id_kartu) }}" method="POST">
                    @csrf @method('PUT')
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label"><i class="fa-solid fa-id-card me-1"></i>ID Kartu</label>
                            <input type="text" name="id_kartu" value="{{ old('id_kartu', $item->id_kartu) }}" class="form-control @error('id_kartu') is-invalid @enderror" placeholder="Masukkan ID kartu" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="point" value="{{ old('point', $item->point) }}" class="form-control @error('point') is-invalid @enderror" placeholder="Point">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" name="tgl_daftar" value="{{ old('tgl_daftar', $item->tgl_daftar) }}" class="form-control @error('tgl_daftar') is-invalid @enderror">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" name="expired" value="{{ old('expired', $item->expired) }}" class="form-control @error('expired') is-invalid @enderror">
