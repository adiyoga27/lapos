...
<div class="card-header"><h4 class="card-title mb-0"><i class="fa-solid fa-plus me-1"></i>Tambah Supplier</h4></div>
<div class="card-body">
...
<input type="text" name="npwp" value="{{ old('npwp') }}" class="form-control @error('npwp') is-invalid @enderror" placeholder="Masukkan NPWP">
@error('npwp')<div class="invalid-feedback">{{ $message }}</div>@enderror
</div>
<div class="col-md-6">
<label class="form-label"><i class="fa-solid fa-user-tie me-1"></i>Contact Person</label>
<input type="text" name="contact" value="{{ old('contact') }}" class="form-control @error('contact') is-invalid @enderror" placeholder="Nama contact person">
...
<input type="text" name="no_rekening" value="{{ old('no_rekening') }}" class="form-control @error('no_rekening') is-invalid @enderror" placeholder="Nomor rekening">
...
<input type="number" name="batas_hutang" value="{{ old('batas_hutang', 0) }}" step="0.01" class="form-control @error('batas_hutang') is-invalid @enderror" placeholder="Batas hutang">
