...
@section('title') Edit Pajak @endsection
@section('content')
<div class="row"><div class="col-12"><div class="card">
<div class="card-header"><h4 class="card-title mb-0"><i class="fa-solid fa-pen me-1"></i>Edit Pajak</h4></div>
<div class="card-body">
<form action="{{ route('pajak.update', $item->kode) }}" method="POST">
@csrf @method('PUT')
<div class="row mb-3">
<div class="col-md-6">
...
<input type="number" name="nilai" value="{{ old('nilai', $item->nilai) }}" step="0.01" required class="form-control @error('nilai') is-invalid @enderror" placeholder="Masukkan nilai">
