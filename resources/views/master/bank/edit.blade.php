    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h4 class="card-title mb-0"><i class="fa-solid fa-pen me-1"></i>Edit Bank</h4>
                <a href="{{ route('bank.index') }}" class="btn btn-secondary btn-sm"><i class="fa-solid fa-arrow-left"></i> Kembali</a>
            </div>
            <div class="card-body">
                <form action="{{ route('bank.update', $item->kode) }}" method="POST">
                    @csrf @method('PUT')
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="beban" value="{{ old('beban', $item->beban) }}" step="0.01" class="form-control @error('beban') is-invalid @enderror" placeholder="Beban">
